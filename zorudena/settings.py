...
ALLOWED_HOSTS = ['localhost','127.0.0.1','zorudena-website-production-fbf7.up.railway.app']
CSRF_TRUSTED_ORIGINS = ['https://zorudena-website-production-fbf7.up.railway.app']
